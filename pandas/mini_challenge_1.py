...
# types of feature 
# input feature -> business_travel distance_from_home environment_satisfaction job_level job_satisfaction monthly_income num_companies_worked percent_salary_hike performance_rating
                    # relationship_satisfaction stock_option_level total_working_years work_life_balance years_at_company years_in_current_role years_since_last_promotion years_with_curr_manager




# can remove -> age daily_rate department education education_field employee_count employee_number gender hourly_rate job_involvement marital_status over18 standard_hours

# not sure about feature -> job_role monthly_rate over_time training_times_last_year
...
# we dropped this columns because we do not need any columns with constants value.
df.drop(
    columns =[
    "over18",
    "employee_count",
...
# employee number is a identifier not a feature 
